    ...
    >
      ...
      <div className="container-custom px-6 md:px-8 lg:px-12 py-16 md:py-20 lg:py-24">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="hero-text text-3xl font-bold mb-6">Project Overview</h2>
        ...
        >
          <div>
            <h3 className="hero-text text-2xl font-bold mb-6">Services Provided</h3>
          ...
          <div>
            <h3 className="hero-text text-2xl font-bold mb-6">Technologies Used</h3>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="hero-text text-2xl font-bold mb-6">Project Gallery</h3>
        ...
        >
          ...
          <p className="body-text text-lg mb-8 max-w-2xl mx-auto text-muted-foreground">
            Let's collaborate to create something amazing for your business. Contact us today to discuss your project.
          </p>
          <Link to="/#contact">
